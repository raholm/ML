...
predictions <- prediction(nn)$rep1
## ---- end-of-assign1-init

## ---- assign1-plot-error
plot(1:it / 1000, errors[1:it], type="o",
     xlab="Threshold", ylab="Mean Squared Error")
## ---- end-of-assign1-plot-error

## ---- assign1-plot-nn
plot(nn, information=FALSE)
## ---- end-of-assign1-plot-nn
